...
class BSTable {
  ...
  init() {
    ...
    if (this.options.editableColumns != null) {
      //Extract felds
      if (typeof this.options.editableColumns == "string") {
  ...
  // Indicate user is editing the row
    ...
    this._modifyEachColumn(this.options.editableColumns, $cols, function($td) {  // modify each column
      ...
      if (content == 'random'){
        var input = "<select name='mode'><option value='random' selected>random</option><option value='limit'>limit</option></select>";
      }else if (content == 'limit') {
        var input = "<select name='mode'><option value='random'>random</option><option value='limit' selected>limit</option></select>";
      }else if (content == 'stop') {
        var input = "<select name='stop'><option value='stop' selected>stop</option><option value='run'>run</option><option value='cancel'>cancel</option></select>";
      }else if (content == 'cancel') {
        var input = "<select name='stop'><option value='stop'>stop</option><option value='run'>run</option><option value='cancel' selected>cancel</option></select>";
      }else if (content == 'run') {
        var input = "<select name='stop'><option value='stop'>stop</option><option value='run' selected>run</option><option value='cancel'>cancel</option></select>";
      }
      else {
